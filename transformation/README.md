...
`../specifications/01-lakeflow.md` (`gold_subscriber_position`, `gold_open_atrisk`,
`gold_retention_outcomes`, `gold_retention_recommendations`, the `ai_classify`
churn signal, …).

If you take the OPTIONAL ML path (`../specifications/03-ml-churn.md`), the
`churn_train_score.py` notebook also lives here.
